...
#==============================================================================
    ...
    model_mc = fit_mcdropout(train_data[var], train_data[y], hidden_dims, dropout, num_epochs, batch_size, lr, train_prop, set_seed)

    num_mc = 1000
    preds = np.zeros((test_data.shape[0], num_mc))
    ...
    results.to_csv(data_dir + method_name + "/" + "mc_dropout_{}_{}_{}.csv".format(set_seed, str(dims), dropout), index = False)
