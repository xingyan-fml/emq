...
#==============================================================================
    ...
    model = fit_sqr(train_data, var, y, hidden_dims, num_epochs, batch_size, lr,
                           train_prop, set_seed)
    Q_predict = sqr_predict(model, test_data, var, tau)  # Q_predict is a numpy array of size N * len(tau)
